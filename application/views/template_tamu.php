          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right">
               <li class="active"><a href="<?php echo base_url();?>">tamu</a></li>
                <li><a href="<?php echo base_url();?>tamu/kamar">Kamar</a></li>
                <!-- <li><a href="<?php echo base_url();?>tamu/reserfasi">Reserfasi</a></li>          -->
                <li><a href="<?php echo base_url();?>tamu/tentang_kami">Tentang Kami</a></li>
                <li><a href="<?php echo base_url();?>tamu/saran">Kritik/Saran</a></li>
                <li><a href="<?php echo base_url();?>tamu/galeri">Gallery</a></li>
              </ul>
            </div>
            <!-- #Nav Ends -->
...
<div class="row">
            <div class="col-lg-3 col-sm-3">
                   <h4>Informasi</h4>
                   <ul class="row">
                <li class="col-lg-12 col-sm-12 col-xs-3"><a href="<?php echo base_url();?>">tamu</a></li>
                <li class="col-lg-12 col-sm-12 col-xs-3"><a href="<?php echo base_url();?>tamu/kamar">Kamar</a></li>         
                <!-- <li class="col-lg-12 col-sm-12 col-xs-3"><a href="<?php echo base_url();?>tamu/reserfasi">Reserfasi</a></li> -->
                <li class="col-lg-12 col-sm-12 col-xs-3"><a href="<?php echo base_url();?>tamu/tentang_kami">Tentang Kami</a></li>
                <li class="col-lg-12 col-sm-12 col-xs-3"><a href="<?php echo base_url();?>tamu/saran">Kritik/Saran</a></li>
              </ul>
            </div>
            
            <div class="col-lg-3 col-sm-3">
                    <h4>Tentang Kami</h4>
                    <p><?php echo character_limiter($isi_tentang_hotel, 100);?><br><a href="<?php echo base_url();?>tamu/tentang_kami">Selengkapnya</a></p>
