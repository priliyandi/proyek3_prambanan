              ...
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  foreach ($data->result_array() as $i) :
                   ...
                   <tr>
                    <td><?php echo $no; ?></td>
                    <td><img src="<?php echo base_url().'assets/images/'.$i['kategori_gambar'];?>" style="width:80px;"></td>
                    <td><?php echo $i['kategori_nama']; ?></td>
                    <td><?php echo $i['kategori_ket']; ?></td>
                    <td>
                     <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $i['kategori_id'];?>"><span class="fa fa-pencil"></span></a>
                     <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $i['kategori_id'];?>"><span class="fa fa-trash"></span></a></td>
                   </tr>
                 <?php endforeach;?>
               </tbody>
             </table>
        ...
        <div class="fetched-data">
          <form class="form-horizontal form-label-left" action="<?php echo base_url()?>padmin/save_kategori" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
               <textarea name="kategori_ket" class="form-control"></textarea>
             </div>
           </div>  
           <div class="form-group">
...
<?php foreach ($data->result_array() as $i) :
  ...
  <div class="modal fade" id="ModalEdit<?php echo $i['kategori_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url().'padmin/update_kategori'?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">       
            <input type="hidden" name="kode" value="<?php echo $i['kategori_id'];?>"/> 

            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Kategori</label>
              <div class="col-md-9 col-sm-9 col-xs-12">
                <input type="text" name="kategori_nama" value="<?php echo $i['kategori_nama'];?>" class="form-control">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Deskripsi</label>
              <div class="col-md-9 col-sm-9 col-xs-12">
                <textarea name="kategori_ket" class="form-control"><?php echo $i['kategori_ket'];?></textarea>
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Ganti Gambar?</label>
              <div class="col-md-9 col-sm-9 col-xs-12">
                <input type="file" name="filefoto">
...
<?php foreach ($data->result_array() as $i) :
  ...
  <div class="modal fade" id="ModalHapus<?php echo $i['kategori_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
