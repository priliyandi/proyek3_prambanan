          ...
          <div class="x_panel">
            <div class="x_title">
              ...
              <ul class="nav navbar-right panel_toolbox">
                <li><a href="#myModaltambah" class="btn btn-default" id="custId" data-toggle="modal" ><i class="fa fa-plus-circle"></i> Tambah Data User</a></li>
              </ul>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
                ...
                <tbody>
                  ...
                  foreach ($data->result_array() as $i) :
                   ...
                   <tr>
                    ...
                    <td>
                     <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $i['user_nik'];?>"><span class="fa fa-pencil"></span></a>
                     <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $i['user_nik'];?>"><span class="fa fa-trash"></span></a></td>
                   </tr>
                 <?php endforeach;?>
               </tbody>
             </table>
      ...
      <div class="modal-body">
        <div class="fetched-data">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
             <textarea name="user_alamat" class="form-control"></textarea>
           </div>
         </div>  
         <div class="form-group">
...
<?php foreach ($data->result_array() as $i) :
  ...
  <div class="modal fade" id="ModalEdit<?php echo $i['user_nik'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <form class="form-horizontal" action="<?php echo base_url().'padmin/update_user'?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">       
           <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">NIK</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="text" name="user_nik" value="<?php echo $i['user_nik']; ?>" class="form-control" readonly>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama</label>
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Username</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="text" name="user_username" value="<?php echo $i['user_username']; ?>" class="form-control">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input type="email" name="user_email" value="<?php echo $i['user_email']; ?>" class="form-control">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tel</label>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <select name="user_role" class="form-control">
                ...
                <option value="resepsionis" <?php if($i['user_role']=='resepsionis'){echo "selected";} else {} ?>>RESEPSIONIS</option>
                <option value="manajemen" <?php if($i['user_role']=='manajemen'){echo "selected";} else {} ?>>MANAJEMEN</option>
              </select>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Alamat</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <textarea name="user_alamat" class="form-control"><?php echo $i['user_alamat']; ?></textarea>
            </div>
          </div>  
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">File</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
             <input type="file" name="filefoto" class="form-control">
             <span>*Kosongkan jika tidak ingin mengganti gabar</span>
           </div>
         </div>
...
<?php foreach ($data->result_array() as $i) :
  ...
  <div class="modal fade" id="ModalHapus<?php echo $i['user_nik'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url().'padmin/delete_user'?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">       
           <input type="hidden" name="kode" value="<?php echo $i['user_nik'];?>"/> 
           <p>Apakah Anda yakin mau menghapus User <b><?php echo $i['user_nama'];?></b> ?</p>
